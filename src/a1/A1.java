...
public class A1 extends JFrame {
    ...
    * @return toolsPanel        the Panel
    ...
    public JPanel setUpToolsPanel() {
        ...
        //New Path
        ImageIcon newpathButtonIcon = createImageIcon("newpath.gif");
         //New Path
        pathComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {fallButtonIcon, bounceButtonIcon, newpathButtonIcon });
        ...
        // To listen for changes in the text <--this is better
            ...
            public void setValue() {
               try {
                    ...
                    //System.out.println("An integer"):
                        if (Integer.parseInt(heightText.getText())<=0 ){
        ...
        widthText.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void setValue() {
               try {
                    ...
                    //System.out.println("An integer"):
                        if (Integer.parseInt(widthText.getText())<=0 ){
        ...
        widthText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                  ...
                  //  JOptionPane.showMessageDialog(null, ""+widthText.getText(), "InfoBox: ", JOptionPane.INFORMATION_MESSAGE);
        ...
        fillButton.addActionListener( new ActionListener() {
            public void actionPerformed( ActionEvent e) {
                ...
                //to avoid tread crash --
                //if stop button was not pressed befor this
                //if(stopButton.isEnabled()){
                  //  JOptionPane.showMessageDialog(null, "Please Stop animation by Stop button to change this!");
                //}else{
